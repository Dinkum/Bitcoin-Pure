...
- outpoints and transaction identifiers: [TX.md](TX.md)
- block headers and `utxo_root` field placement: [BLOCK.md](BLOCK.md)
- shared integer and byte encoding rules: [SERIALIZATION.md](SERIALIZATION.md)
